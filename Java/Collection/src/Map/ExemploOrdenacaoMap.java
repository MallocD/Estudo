...
public class ExemploOrdenacaoMap {
    public static void main(String[] args) {
        ...
        Set<Map.Entry<String,Livro>> meu = new TreeSet<>(Comparator.comparing(
                l1->l1.getValue().getPaginas()));

        meu.addAll(meusLivros.entrySet());
        for(Map.Entry<String,Livro> livro : meu){
